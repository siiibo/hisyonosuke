...
export function getUpdatedUserWorkStatus(userWorkStatus: UserWorkStatus | undefined,
  newCommand: CommandType): UserWorkStatus {
...
export function getUserWorkStatusesByMessages(messages: Message[], botUserId: string): { [userSlackId: string]: UserWorkStatus | undefined; } {
