...
import { createOnOpen, getUserConfig } from "./sheets/UserConfigSheet";
...
export const main = () => {
  ...
  const { outputSpreadSheetUrl, targetYear, targetMonth } = getUserConfig(
    USER_CONFIG_SPREADSHEET_URL,
    USER_CONFIG_SHEET_NAME,
  );
  ...
  const colorSettings = [
    ...
    {
      text: [
        COMMAND_LABEL[":kinmukaishi:"],
        COMMAND_LABEL[":sagyoukaishi:"],
        COMMAND_LABEL[":shukkin:"],
        COMMAND_LABEL[":shussha:"],
      ],
      colorCode: "#E6F4EA",
    },
    {
      text: [
        COMMAND_LABEL[":kinmushuuryou:"],
        COMMAND_LABEL[":sagyoushuuryou:"],
        COMMAND_LABEL[":taikin:"],
        COMMAND_LABEL[":saishuutaikin:"],
      ],
      colorCode: "#C8DAF9",
    },
  ];
